...
Между повторными попытками crawler делает паузу. Если задан `--delay` или `--rps`, используется общее ограничение скорости запросов. Если ограничение скорости не задано, используется небольшая задержка по умолчанию.
